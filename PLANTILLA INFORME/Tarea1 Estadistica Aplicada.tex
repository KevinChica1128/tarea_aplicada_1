...
~\\ Ubicamos las localizaciones en un mapa, con el software R, mas específicamente con la librería 'ggmap', para tener una idea geográfica de donde provenían nuestros 500 bloques muestreados, los resultados se aprecian en las siguientes dos gráficas:
\begin{figure}[!htb]
  \centering
