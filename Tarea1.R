...
x11()
par(mfrow=c(1,2))
hist(cadata$Ingreso_medio,freq = F)
...
x11()
par(mfrow=c(1,2))
hist(cadata$Edad_media_de_la_vivienda,freq = F)
...
x11()
par(mfrow=c(1,2))
hist(cadata$Total_de_habitaciones, freq = F)
...
x11()
par(mfrow=c(1,2))
hist(cadata$Total_de_dormitorios, freq = F)
