...
\begin{figure}[!h]
    \begin{center}
        \includegraphics[width=10cm]{imagenes/comparacion.png}
        \caption{Comparacion de los modelos generados con selección de variables}
        \label{fig:Densidad}
    \end{center}
\end{figure}
\end{frame}
